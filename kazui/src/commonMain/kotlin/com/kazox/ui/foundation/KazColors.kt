...
/**
 * KazColors defines all semantic color tokens for the design system.
 *
...
public val LocalKazColors: androidx.compose.runtime.ProvidableCompositionLocal<KazColors> =
    staticCompositionLocalOf<KazColors> {
        error("No KazColors provided. Wrap your content in KazTheme { ... }")
    }
