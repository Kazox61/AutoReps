...
/**
 * KazMotion defines the animation token system for the design system.
 *
 ...
 * **1. Presets (quickest):**
 * ```
 * KazTheme(motion = KazMotionPresets.snappy()) { ... }
 * KazTheme(motion = KazMotionPresets.playful()) { ... }
 * KazTheme(motion = KazMotionPresets.minimal()) { ... }
 * ```
 *
...
public val LocalKazMotion: androidx.compose.runtime.ProvidableCompositionLocal<KazMotion> =
    staticCompositionLocalOf<KazMotion> {
        error(
            "No KazMotion provided. Wrap your content in KazTheme { ... }",
        )
    }
