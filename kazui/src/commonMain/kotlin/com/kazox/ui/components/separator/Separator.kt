package com.kazox.ui.components.separator
 ...
 * @param color Line color; [Color.Unspecified] defaults to [KazTheme.colors.border].
...
public fun Separator(
    ...
    val resolvedColor =
        if (color != Color.Unspecified) color else KazTheme.colors.border
