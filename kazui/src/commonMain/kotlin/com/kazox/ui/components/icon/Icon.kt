package com.kazox.ui.components.icon
 ...
 *
 * ```
 * Icon(KazIcons.Heart, contentDescription = "Favorite")
 *
 * Icon(
 *     imageVector = KazIcons.Settings,
 ...
 * ```
 *
 * @param imageVector The [ImageVector] to render (e.g. from [KazIcons]).
